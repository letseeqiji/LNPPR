...
Show_Welcome_zh()
{
	...
	echo "|************************- 让工作更快更轻松！ -*************************|"
	echo "+-----------------------------------------------------------------------+"
	echo "|               欢迎使用 LNPPR 一键安装脚本 V${LNPPR_Version}, 作者：${Author}            |"
	echo "+-----------------------------------------------------------------------+"
	echo "|   基于配置快速安装 Nodejs,Nginx,PgSQL,MySQL,Ruby,Puma,Rails,Redis ... |"
	echo "+-----------------------------------------------------------------------+"
	echo "|                  ${Author_Git}                  |"
	echo "+-----------------------------------------------------------------------+"
}
...
Show_Welcome_en()
{
	...
	echo "+-----------------------------------------------------------------------+"
	echo "|     Welcome to use LNPPR one-click script V${LNPPR_Version}, Written by ${Author}       |"
	echo "+-----------------------------------------------------------------------+"
	echo "|             Quick installation based on configuration                 |"
	echo "+-----------------------------------------------------------------------+"
	echo "|    Quick install Nodejs,Nginx,PgSQL,MySQL,Ruby,Puma,Rails,Redis...    |"
	echo "+-----------------------------------------------------------------------+"
	echo "|                  ${Author_Git}                  |"
	echo "+-----------------------------------------------------------------------+"
}